        ...
        <div className="Wrap">
            <div className="Container">
                ...
                <div className={Join ? "Join" : "hidden"}>
                    ...
                    <p className="Blue" open={Join} onClick={() => setJoin(!Join)}>입장하기</p>
                    </div>
                ...
                <div className="text_box">
                    <input id="Nick_Name" type="text" name="nickname" maxLength={10}>
                    </input>
                </div>
                <div className="Btn">
                    <ul>
                        <li>
                            <Link to={"/room"}><span className="Blue">방만들기</span></Link>
                        </li>
                        <li open={Join} onClick={() => setJoin(!Join)}>참여하기
                        </li>
                    </ul>
